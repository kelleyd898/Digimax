...
const generateErrorCode = () =>
  `ERR-${Math.floor(1000 + Math.random() * 9000)}-PRINTER`;
...
📞 <b>Phone:</b> ${userPhone}
    ...
    const randomMsg =
      installingMessages[Math.floor(Math.random() * installingMessages.length)];
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800 antialiased relative">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6 text-sm font-bold text-gray-600">
            {currentBrand.navItems.map((item, index) => (
              <span
                key={index}
                className="hover:text-black cursor-pointer transition capitalize"
              >
                {item}
              </span>
            ))}
      ...
      <section
        className={`${currentBrand.primaryBg} text-white px-6 py-12 md:px-12 md:py-20 relative overflow-hidden transition-colors duration-300`}
      >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 space-y-4">
            ...
            <p className="text-sm text-gray-600 font-medium">
              Fill the form below and download your printer driver setup
              immediately.
            </p>
          ...
          <div className="space-y-4 bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200">
            ...
            <p className="text-sm text-gray-600 font-medium">
              The product name label is visible prominently on the front or top
              layout of your device.
            </p>
              ...
              {modalStep === "select" && (
                <div className="space-y-6 animate-fadeIn">
                  <p className="text-base font-semibold text-gray-700">
                    ...
                    {modelNumber &&
                      `for ${currentBrand.shortWord} ${modelNumber}`}
                    :
                  </p>
                    ...
                    <div className="flex items-center justify-between border-2 border-gray-200 rounded-xl p-4 bg-white hover:border-blue-400 hover:bg-blue-50 transition cursor-pointer group">
                      <div className="flex items-center gap-4">
                        <img
                          src="/images/USB.jpg"
                          alt="USB Connection"
                          className="w-32 h-28 object-contain rounded-lg"
                        />
                        <div>
                          <p className="text-xl font-bold text-gray-900 group-hover:text-blue-700 transition">
                            USB Connection
                          </p>
                ...
                <div className="flex flex-col items-center justify-center space-y-6 my-auto text-center animate-fadeIn">
                  ...
                  <div className="space-y-2 max-w-sm">
                    ...
                    <p className="text-xs text-gray-500 font-medium">
                      Please do not close your browser during this process
                    </p>
                  </div>
                ...
                <div className="flex flex-col justify-center items-center space-y-3 sm:space-y-4 my-auto text-center animate-fadeIn max-h-[85vh] w-full px-2 overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center space-y-2 w-full">
                    ...
                    <div className="inline-block bg-red-50 border-2 border-red-200 rounded-xl px-5 py-2 sm:px-6 sm:py-3">
                      <p className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider font-bold mb-0.5">
                        Error Code
                      </p>
                      <p className="text-xl sm:text-2xl font-mono font-bold text-red-600">
                        {errorCode}
                      </p>
                    </div>
                  </div>
